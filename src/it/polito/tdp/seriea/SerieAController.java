...
public class SerieAController {
    ...
    void doSelezionaSquadra(ActionEvent event) {
    	...
    	Map<Season, Integer> punteggi = model.calcolaPunteggi(team);
    	
    	for(Season s: punteggi.keySet()) {
    		txtResult.appendText("Stagione: "+s.getDescription()+" punti: "+punteggi.get(s)+"\n");
    	}
    ...
    void doTrovaAnnataOro(ActionEvent event) {
    	...
    	txtResult.appendText(String.format("Annata d'oro è: %s\n", annata.getDescription()));
